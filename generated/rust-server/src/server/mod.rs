    ...
    
{
    ...
    Router::new()
        ...
        .route("/api/v1/players/search",
            get(search_player::<I, A, E>)
        )
        .route("/api/v1/players/{puuid}/profile",
...
let result = api_impl.as_ref().get_player_profile(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::players::GetPlayerProfileResponse::Status200_ArenaProfileSummary
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::players::GetPlayerProfileResponse::Status404_PlayerProfileNotFound
                                                    (body)
                                                => {
...
fn search_player_validation(
  ...
  models::SearchPlayerQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
...
let result = api_impl.as_ref().search_player(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::players::SearchPlayerResponse::Status200_ResolvedPlayerIdentity
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::players::SearchPlayerResponse::Status400_InvalidPlayerSearchQuery
                                                    (body)
                                                => {
                                                ...
                                                apis::players::SearchPlayerResponse::Status404_PlayerNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
