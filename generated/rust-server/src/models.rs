    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ActiveArenaSummary".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "in_game" => intermediate_rep.in_game.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "queue_id" => intermediate_rep.queue_id.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "game_start_time" => intermediate_rep.game_start_time.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ActiveArenaSummary".to_string())
                }
            }
        ...
        std::result::Result::Ok(ActiveArenaSummary {
            in_game: intermediate_rep.in_game.into_iter().next().ok_or_else(|| "in_game missing in ActiveArenaSummary".to_string())?,
            queue_id: intermediate_rep.queue_id.into_iter().next().ok_or_else(|| "queue_id missing in ActiveArenaSummary".to_string())?,
            game_start_time: intermediate_rep.game_start_time.into_iter().next().ok_or_else(|| "game_start_time missing in ActiveArenaSummary".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ActiveArenaSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ActiveArenaSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ActiveArenaSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ActiveArenaSummary as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ActiveArenaSummary - {err}"#))
                    }
             },
...
impl std::str::FromStr for ArenaRankSummary {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ArenaRankSummary".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "tier" => intermediate_rep.tier.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "rank" => intermediate_rep.rank.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "league_points" => intermediate_rep.league_points.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ArenaRankSummary".to_string())
                }
            }
        ...
        std::result::Result::Ok(ArenaRankSummary {
            tier: intermediate_rep.tier.into_iter().next().ok_or_else(|| "tier missing in ArenaRankSummary".to_string())?,
            rank: intermediate_rep.rank.into_iter().next().ok_or_else(|| "rank missing in ArenaRankSummary".to_string())?,
            league_points: intermediate_rep.league_points.into_iter().next().ok_or_else(|| "league_points missing in ArenaRankSummary".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ArenaRankSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ArenaRankSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ArenaRankSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ArenaRankSummary as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ArenaRankSummary - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for ErrorResponse1 {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ErrorResponse1".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "message" => intermediate_rep.message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ErrorResponse1".to_string())
                }
            }
        ...
        std::result::Result::Ok(ErrorResponse1 {
            message: intermediate_rep.message.into_iter().next().ok_or_else(|| "message missing in ErrorResponse1".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ErrorResponse1>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ErrorResponse1>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for ErrorResponse1 - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ErrorResponse1 as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into ErrorResponse1 - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl PlayerProfile {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(puuid: String, game_name: String, tagline: String, summoner_id: String, summoner_level: u32, profile_icon_id: u32, ) -> PlayerProfile {
        PlayerProfile {
 puuid,
 game_name,
 tagline,
...
impl std::str::FromStr for PlayerProfile {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PlayerProfile".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "game_name" => intermediate_rep.game_name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "tagline" => intermediate_rep.tagline.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "summoner_id" => intermediate_rep.summoner_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "summoner_level" => intermediate_rep.summoner_level.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "profile_icon_id" => intermediate_rep.profile_icon_id.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "arena_rank" => intermediate_rep.arena_rank.push(<models::ArenaRankSummary as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "active_arena" => intermediate_rep.active_arena.push(<models::ActiveArenaSummary as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing PlayerProfile".to_string())
                }
            }
        ...
        std::result::Result::Ok(PlayerProfile {
            puuid: intermediate_rep.puuid.into_iter().next().ok_or_else(|| "puuid missing in PlayerProfile".to_string())?,
            game_name: intermediate_rep.game_name.into_iter().next().ok_or_else(|| "game_name missing in PlayerProfile".to_string())?,
            tagline: intermediate_rep.tagline.into_iter().next().ok_or_else(|| "tagline missing in PlayerProfile".to_string())?,
            summoner_id: intermediate_rep.summoner_id.into_iter().next().ok_or_else(|| "summoner_id missing in PlayerProfile".to_string())?,
            summoner_level: intermediate_rep.summoner_level.into_iter().next().ok_or_else(|| "summoner_level missing in PlayerProfile".to_string())?,
            profile_icon_id: intermediate_rep.profile_icon_id.into_iter().next().ok_or_else(|| "profile_icon_id missing in PlayerProfile".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<PlayerProfile>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PlayerProfile>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PlayerProfile - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PlayerProfile as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PlayerProfile - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl PlayerProfileResponse {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(player: models::PlayerProfile, recent_matches: Vec<models::RecentArenaMatchSummary>, ) -> PlayerProfileResponse {
...
impl std::str::FromStr for PlayerProfileResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PlayerProfileResponse".to_string())
            };
        ...
        std::result::Result::Ok(PlayerProfileResponse {
            player: intermediate_rep.player.into_iter().next().ok_or_else(|| "player missing in PlayerProfileResponse".to_string())?,
            recent_matches: intermediate_rep.recent_matches.into_iter().next().ok_or_else(|| "recent_matches missing in PlayerProfileResponse".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<PlayerProfileResponse>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PlayerProfileResponse>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PlayerProfileResponse - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PlayerProfileResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PlayerProfileResponse - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for PlayerSearchResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PlayerSearchResponse".to_string())
            };
        ...
        std::result::Result::Ok(PlayerSearchResponse {
            results: intermediate_rep.results.into_iter().next().ok_or_else(|| "results missing in PlayerSearchResponse".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<PlayerSearchResponse>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PlayerSearchResponse>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PlayerSearchResponse - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PlayerSearchResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PlayerSearchResponse - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl std::str::FromStr for PlayerSearchResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PlayerSearchResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "tagline" => intermediate_rep.tagline.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing PlayerSearchResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(PlayerSearchResult {
            puuid: intermediate_rep.puuid.into_iter().next().ok_or_else(|| "puuid missing in PlayerSearchResult".to_string())?,
            game_name: intermediate_rep.game_name.into_iter().next().ok_or_else(|| "game_name missing in PlayerSearchResult".to_string())?,
            tagline: intermediate_rep.tagline.into_iter().next().ok_or_else(|| "tagline missing in PlayerSearchResult".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<PlayerSearchResult>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PlayerSearchResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for PlayerSearchResult - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PlayerSearchResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into PlayerSearchResult - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl RecentArenaMatchSummary {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(match_id: String, queue_id: i32, game_creation: i64, game_end_timestamp: i64, participants: Vec<models::RecentArenaParticipantSummary>, ) -> RecentArenaMatchSummary {
...
impl std::str::FromStr for RecentArenaMatchSummary {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RecentArenaMatchSummary".to_string())
            };
        ...
        std::result::Result::Ok(RecentArenaMatchSummary {
            match_id: intermediate_rep.match_id.into_iter().next().ok_or_else(|| "match_id missing in RecentArenaMatchSummary".to_string())?,
            queue_id: intermediate_rep.queue_id.into_iter().next().ok_or_else(|| "queue_id missing in RecentArenaMatchSummary".to_string())?,
            game_creation: intermediate_rep.game_creation.into_iter().next().ok_or_else(|| "game_creation missing in RecentArenaMatchSummary".to_string())?,
            game_end_timestamp: intermediate_rep.game_end_timestamp.into_iter().next().ok_or_else(|| "game_end_timestamp missing in RecentArenaMatchSummary".to_string())?,
            participants: intermediate_rep.participants.into_iter().next().ok_or_else(|| "participants missing in RecentArenaMatchSummary".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<RecentArenaMatchSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<RecentArenaMatchSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for RecentArenaMatchSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RecentArenaMatchSummary as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into RecentArenaMatchSummary - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
...
impl RecentArenaParticipantSummary {
    #[allow(clippy::new_without_default, clippy::too_many_arguments)]
    pub fn new(puuid: String, placement: u32, champion_id: u32, kills: u32, deaths: u32, assists: u32, ) -> RecentArenaParticipantSummary {
...
impl std::str::FromStr for RecentArenaParticipantSummary {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RecentArenaParticipantSummary".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "puuid" => intermediate_rep.puuid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "placement" => intermediate_rep.placement.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "champion_id" => intermediate_rep.champion_id.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "kills" => intermediate_rep.kills.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "deaths" => intermediate_rep.deaths.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "assists" => intermediate_rep.assists.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing RecentArenaParticipantSummary".to_string())
                }
            }
        ...
        std::result::Result::Ok(RecentArenaParticipantSummary {
            puuid: intermediate_rep.puuid.into_iter().next().ok_or_else(|| "puuid missing in RecentArenaParticipantSummary".to_string())?,
            placement: intermediate_rep.placement.into_iter().next().ok_or_else(|| "placement missing in RecentArenaParticipantSummary".to_string())?,
            champion_id: intermediate_rep.champion_id.into_iter().next().ok_or_else(|| "champion_id missing in RecentArenaParticipantSummary".to_string())?,
            kills: intermediate_rep.kills.into_iter().next().ok_or_else(|| "kills missing in RecentArenaParticipantSummary".to_string())?,
            deaths: intermediate_rep.deaths.into_iter().next().ok_or_else(|| "deaths missing in RecentArenaParticipantSummary".to_string())?,
            assists: intermediate_rep.assists.into_iter().next().ok_or_else(|| "assists missing in RecentArenaParticipantSummary".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<RecentArenaParticipantSummary>> for HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<RecentArenaParticipantSummary>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Invalid header value for RecentArenaParticipantSummary - value: {hdr_value} is invalid {e}"#))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RecentArenaParticipantSummary as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(format!(r#"Unable to convert header value '{value}' into RecentArenaParticipantSummary - {err}"#))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(format!(r#"Unable to convert header: {hdr_value:?} to string: {e}"#))
        }
